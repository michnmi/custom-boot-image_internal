        ...
        stage('Send qcow over to vmhosts') {
            steps {
                withCredentials([
                    ...
                    sh 'rsync -a  --rsync-path="sudo rsync"  -e "ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins" output-ubuntu22.04_baseos/ubuntu22.04_baseos.qcow2 $JENKINS_USER_NAME@vmhost02:/vmhost_qcow/boot/ubuntu22.04_baseos_latest.qcow2  --progress'
