        ...
        stage('Send qcow over to vmhost') {
            steps {
                withCredentials([
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@192.168.122.1: "chown libvirt-qemu:kvm /zpools/vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2"'
                }
            }
        }
