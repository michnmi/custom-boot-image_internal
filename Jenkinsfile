        ...
        stage('Send qcow over to vmhosts') {
            steps {
                withCredentials([
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost01 "sudo chmod 660 /zpools/vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2"'
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost02 "sudo chmod 660 /zpools/vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2"'
                    sh 'rsync -a  --rsync-path="sudo rsync"  -e "ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins" output-ubuntu18.04_baseos/ubuntu18.04_baseos.qcow2 $JENKINS_USER_NAME@vmhost03:/vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2  --progress'
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost03 "sudo chown libvirt-qemu:kvm /vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2"'
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost03 "sudo chmod 660 /vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2"'
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost01 "sudo chmod 660 /zpools/vmhost_qcow/boot/ubuntu22.04_baseos_latest.qcow2"'
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost02 "sudo chmod 660 /zpools/vmhost_qcow/boot/ubuntu22.04_baseos_latest.qcow2"'
        ...
        stage('Update image to be used - vmhost01.') {
            steps {
                withCredentials([
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost01 "sudo cp -p /zpools/vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2 /zpools/vmhost_qcow/boot/ubuntu18.04_baseos.qcow2"'
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost01 "sudo mv /zpools/vmhost_qcow/boot/ubuntu22.04_baseos.qcow2 /zpools/vmhost_qcow/boot/ubuntu22.04_baseos_previous.qcow2"'
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost01 "sudo cp -p /zpools/vmhost_qcow/boot/ubuntu22.04_baseos_latest.qcow2 /zpools/vmhost_qcow/boot/ubuntu22.04_baseos.qcow2"'
                }
            }
        }
        stage('Update image to be used - vmhost02.') {
            steps {
                withCredentials([
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost02 "sudo cp -p /zpools/vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2 /zpools/vmhost_qcow/boot/ubuntu18.04_baseos.qcow2"'
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost02 "sudo mv /zpools/vmhost_qcow/boot/ubuntu22.04_baseos.qcow2 /zpools/vmhost_qcow/boot/ubuntu22.04_baseos_previous.qcow2"'
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost02 "sudo cp -p /zpools/vmhost_qcow/boot/ubuntu22.04_baseos_latest.qcow2 /zpools/vmhost_qcow/boot/ubuntu22.04_baseos.qcow2"'
                }
            }
        }
        stage('Update image to be used - vmhost03.') {
            steps {
                withCredentials([
                    ...
                    sh 'chmod 600 ssh_keys/id_ed25519_jenkins'
                    sh 'sed -i -e \'/^$/d\' ssh_keys/id_ed25519_jenkins'
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost03 "sudo mv /vmhost_qcow/boot/ubuntu18.04_baseos.qcow2 /vmhost_qcow/boot/ubuntu18.04_baseos_previous.qcow2"'
                    sh 'ssh -o StrictHostKeyChecking=no -i ssh_keys/id_ed25519_jenkins $JENKINS_USER_NAME@vmhost03 "sudo cp -p /vmhost_qcow/boot/ubuntu18.04_baseos_latest.qcow2 /vmhost_qcow/boot/ubuntu18.04_baseos.qcow2"'
